                    ...
                    <tbody>
                        @foreach ($wahana as $data)
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('wahana.destroy', $data->id) }}" method="POST">
                                        @csrf
                                        @method('delete')
                                        <a href="{{ route('wahana.destroy', $data->id) }}" type="button"
                ...
                <form action="{{ route('wahana.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="kode" name="stok" placeholder="50 tiket"
                                required />
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control-file" id="dokumentasi" name="image"
